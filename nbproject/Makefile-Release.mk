...
${OBJECTDIR}/src/HTTP/HTTP.o: src/HTTP/HTTP.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HTTP/HTTP.o src/HTTP/HTTP.cpp

${OBJECTDIR}/src/Request.o: src/Request.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Request.o src/Request.cpp

${OBJECTDIR}/src/Response.o: src/Response.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Response.o src/Response.cpp

${OBJECTDIR}/src/client.o: src/client.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/client.o src/client.cpp

${OBJECTDIR}/src/pugixml/pugixml.o: src/pugixml/pugixml.cpp
	${MKDIR} -p ${OBJECTDIR}/src/pugixml
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pugixml/pugixml.o src/pugixml/pugixml.cpp
...
${TESTDIR}/tests/Base64Test.o: tests/Base64Test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -Iinclude -std=c++98 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/Base64Test.o tests/Base64Test.cpp
...
${OBJECTDIR}/src/HTTP/HTTP_nomain.o: ${OBJECTDIR}/src/HTTP/HTTP.o src/HTTP/HTTP.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HTTP/HTTP_nomain.o src/HTTP/HTTP.cpp;\
	else  \
...
${OBJECTDIR}/src/Request_nomain.o: ${OBJECTDIR}/src/Request.o src/Request.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Request_nomain.o src/Request.cpp;\
	else  \
...
${OBJECTDIR}/src/Response_nomain.o: ${OBJECTDIR}/src/Response.o src/Response.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Response_nomain.o src/Response.cpp;\
	else  \
...
${OBJECTDIR}/src/client_nomain.o: ${OBJECTDIR}/src/client.o src/client.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/client_nomain.o src/client.cpp;\
	else  \
...
${OBJECTDIR}/src/pugixml/pugixml_nomain.o: ${OBJECTDIR}/src/pugixml/pugixml.o src/pugixml/pugixml.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Iinclude -Iinclude/wsdl-library -std=c++98 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/pugixml/pugixml_nomain.o src/pugixml/pugixml.cpp;\
	else  \
